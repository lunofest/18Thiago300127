const CACHE_NAME = 'cache-v19'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v19',
    'estilos/styles.css?v19',
    'estilos/mediaQueries.css?v19',
    'javascript/script.js?v19',
